...
<Response>
  <Gather input="dtmf" numDigits="1" timeout="10" action="${BASE_URL}/voice-outbound-greeting?reminder_id=${reminderId}" method="POST">
    <Say voice="Google.en-US-Studio-M">This is the Reminder Service. Press any key to hear your message.</Say>
  </Gather>
  <Pause length="3"/>
  <Say voice="Google.en-US-Studio-M">This is a reminder for ${userName}.</Say>
  <Play>${proxyUrl}</Play>
  <Say voice="Google.en-US-Studio-M">This message was sent by the Reminder Service. Goodbye.</Say>
  <Hangup/>
</Response>`)
})
